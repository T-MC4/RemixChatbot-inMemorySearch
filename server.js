...
app.post("/search/update", async (req, res) => {
  ...
  await saveDataToS3("./data/to_process", "to_process");
  await saveDataToS3("./data/processed", "processed");
  await saveDataToS3("./data/indexing", "indexing");
...
app.post("/api/embed", async (req, res) => {
  ...
  await saveDataToS3("./data/indexing", "indexing").catch((err) => {
...
const server = app.listen(port, async () => {
  ...
  await loadDataFromS3("to_process", "./data/to_process");
  await loadDataFromS3("processed", "./data/processed");
  await loadDataFromS3("indexing", "./data/indexing");
